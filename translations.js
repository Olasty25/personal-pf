const translations = {
  en: {
    ...
    project2Title: "AI Chatbot Integration",
    project2Desc: "AI Development",
    project3Title: "Portfolio Website Redesign",
    project3Desc: "UI/UX Design",
    project4Title: "SaaS For File Transfer",
  ...
  pl: {
    ...
    project1Desc: "Web Development",
    project2Title: "Integracja Chatbota AI",
    project2Desc: "Rozwój AI",
    project3Title: "Przeprojektowanie Strony Portfolio",
    project3Desc: "Projektowanie UI/UX",
    project4Title: "SaaS do Transferu Plików",
    project4Desc: "Full-Stack Development",
    // Contact Section
