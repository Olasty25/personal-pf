const translations = {
  en: {
    ...
    project1Title: "Luxury hairdresser",
    project1Desc: "Web Development",
    project2Title: "Portfolio 2",
    project2Desc: "Web Development",
    project3Title: "Portfolio 1",
    project3Desc: "UI/UX Design",
    project4Title: "Car repair",
    project4Desc: "UI/UX Design",
    project5Title: "Coffee Shop",
    project5Desc: "Projektowanie UI/UX",
    project6Title: "Lawyer Service",
    project6Desc: "Projektowanie UI/UX",
    // Contact Section
  ...
  pl: {
    ...
    worksSubtitle: "Wybór moich ulubionych projektów. Kliknij, aby zobaczyć podgląd na żywo.",
    project1Title: "Salon Stylizacji Włosów",
    project1Desc: "Web Development",
    project2Title: "Portfolio 2",
    project2Desc: "Web Development",
    project3Title: "Portfolio 1",
    project3Desc: "Projektowanie UI/UX",
    project4Title: "Strona Firnmy Wulkanizacyjnej",
    project4Desc: "Projektowanie UI/UX",
    project5Title: "Strona Kawiarni",
    project5Desc: "Projektowanie UI/UX",
    project6Title: "Usługi Prawnicze",
    project6Desc: "Projektowanie UI/UX",
    // Contact Section
